#!/usr/bin/env python3
"""Métriques de performance pur-python — portées de Dexterio + littérature quant.
...
maxDD reprend la math de Dexterio backtest/metrics.py (max(peak-equity) sur l'equity
